...
const MANUAL_CODE_OVERRIDES = {
  ...
  // Legacy truncated duplicates of the accented TARIFAS TRÁMITES CAMADAS products —
  // unmapped to avoid colliding on the same code. Product itself still exists live.
  "RECARGO POR INSCRIPCION DE CACHORROACCESS LBO RBR CON MAS DE 12 MESES Y MENOS": null,
  "RECARGO POR INSCRIPCION DE CACHORROACCESS LBO RBR CON MAS DE 6 MESES Y MENOS": null,
  "RECARGO POR INSCRIPCION DE CACHORROACCESS LBO RBR CON MAS DE 9 MESES Y MENOS": null,
...
"CESIÓN TEMPORAL DE PROPIEDAD DE LOS REPRODUCTORES": "11300002",
